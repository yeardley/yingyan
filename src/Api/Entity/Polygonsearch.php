<?php
/**
 * Package Yeardley\Yingyan\Api\Entity\Polygonsearch
 * @Author yeardley
...
class Polygonsearch extends Api
{
     ...
     *
     * @param vertexes	多边形边界点	string	必选	“double,double;double,double; ...;double,double”
     *                  规则： 经纬度顺序为：纬度,经度； 顶点顺序可按顺时针或逆时针排列。 多边形外接矩形面积不超过3000平方公里
     *
